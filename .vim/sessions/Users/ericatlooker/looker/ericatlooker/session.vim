...
silent only
cd ~/looker/ericatlooker
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 .git/rebase-merge/git-rebase-todo
args .git/rebase-merge/git-rebase-todo
...
setlocal keywordprg=git\ --git-dir='/Users/ericatlooker/looker/ericatlooker/.git'\ show
...
setlocal omnifunc=
setlocal path=~/looker/ericatlooker/.git,~/looker/ericatlooker,
